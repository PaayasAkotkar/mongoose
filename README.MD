...
ACE-> [cutting-file-into-pieces](./golang/ref/cutting-file-into-pieces.pdf) this is the name i gave it
...
- remote transfer packets so that we can create remote desktop
- more control over go-concurrency method's